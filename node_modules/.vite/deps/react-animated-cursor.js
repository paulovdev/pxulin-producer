...
var IsDevice = function() {
  ...
  return {
    ...
    any: function() {
      var _a, _b, _c, _d, _e;
      return !!(((_a = IsDevice.Android()) === null || _a === void 0 ? void 0 : _a.length) || ((_b = IsDevice.BlackBerry()) === null || _b === void 0 ? void 0 : _b.length) || ((_c = IsDevice.iOS()) === null || _c === void 0 ? void 0 : _c.length) || IsDevice.iPad() || ((_d = IsDevice.OperaMini()) === null || _d === void 0 ? void 0 : _d.length) || ((_e = IsDevice.IEMobile()) === null || _e === void 0 ? void 0 : _e.length));
    }
    // Return boolean
  };
}();
